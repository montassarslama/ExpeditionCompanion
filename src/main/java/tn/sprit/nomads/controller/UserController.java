package tn.sprit.nomads.controller;
...
class UserResource {
    ...
    //localhost:8082/api/role/addtouser?roleName=ROLE_ADMIN&username=john
    @PostMapping("/role/addtouser")
    public ResponseEntity<?>addRoleToUser(@RequestParam  String username,@RequestParam  String roleName ) {
        userService.addRoleToUser(username,roleName);
        return ResponseEntity.ok().build();
    }
    //localhost:8082/api/role/deletetouser?roleName=ROLE_ADMIN&username=john
